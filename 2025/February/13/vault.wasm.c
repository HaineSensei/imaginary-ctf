...
/* export: '__stdio_exit' */
void w2c__0x5F_stdio_exit(w2c_*);
...
static u32 w2c__f1(w2c_*, u32);
static u32 w2c__f2(w2c_*, u32);
static u32 w2c__f3(w2c_*, u32);
static u32 w2c__f4(w2c_*, u32);
static u32 w2c__f5(w2c_*, u32);
static u32 w2c__f6(w2c_*, u32);
static u32 w2c__f7(w2c_*, u32);
static u32 w2c__f8(w2c_*, u32, u32, u32);
static u32 w2c__f9(w2c_*, u32, u32);
static u32 w2c__check_pin_0(w2c_*, u32);
...
static void w2c__f18(w2c_*, u32);
static u32 w2c__f19(w2c_*);
static u32 w2c__f20(w2c_*, u32);
static void w2c__0x5F_stdio_exit_0(w2c_*);
static void w2c__f22(w2c_*, u32);
...
FUNC_TYPE_T(w2c__t2) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";
...
/* export: 'check_pin' */
u32 w2c__check_pin(w2c_* instance, u32 var_p0) {
#if WASM_RT_USE_SEGUE
  uintptr_t segue_saved_base = WASM_RT_SEGUE_READ_BASE();
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
  u32 ret = w2c__check_pin_0(instance, var_p0);
#if WASM_RT_USE_SEGUE
  WASM_RT_SEGUE_WRITE_BASE(segue_saved_base);
#endif
  return ret;
...
u32 w2c__0x5F_errno_location(w2c_* instance) {
  ...
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
  u32 ret = w2c__0x5F_errno_location_0(instance);
#if WASM_RT_USE_SEGUE
  WASM_RT_SEGUE_WRITE_BASE(segue_saved_base);
#endif
  return ret;
...
/* export: '__stdio_exit' */
void w2c__0x5F_stdio_exit(w2c_* instance) {
#if WASM_RT_USE_SEGUE
  uintptr_t segue_saved_base = WASM_RT_SEGUE_READ_BASE();
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
  w2c__0x5F_stdio_exit_0(instance);
#if WASM_RT_USE_SEGUE
  WASM_RT_SEGUE_WRITE_BASE(segue_saved_base);
#endif
}
...
u32 w2c__stackSave(w2c_* instance) {
  ...
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
  u32 ret = w2c__stackSave_0(instance);
#if WASM_RT_USE_SEGUE
  WASM_RT_SEGUE_WRITE_BASE(segue_saved_base);
#endif
  return ret;
...
u32 w2c__stackAlloc(w2c_* instance, u32 var_p0) {
  ...
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
  u32 ret = w2c__stackAlloc_0(instance, var_p0);
#if WASM_RT_USE_SEGUE
  WASM_RT_SEGUE_WRITE_BASE(segue_saved_base);
#endif
  return ret;
...
u32 w2c__f1(w2c_* instance, u32 var_p0) {
...
u32 w2c__f3(w2c_* instance, u32 var_p0) {
  u32 var_l1 = 0, var_l2 = 0, var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, 
...
u32 w2c__f5(w2c_* instance, u32 var_p0) {
  u32 var_l1 = 0, var_l2 = 0, var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, 
      var_l9 = 0, var_l10 = 0, var_l11 = 0, var_l12 = 0, var_l13 = 0, var_l14 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
...
u32 w2c__f6(w2c_* instance, u32 var_p0) {
  u32 var_l1 = 0, var_l2 = 0, var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, 
  ...
  var_l4 = var_i0;
  var_i0 = var_l4;
  var_i0 = w2c__f1(instance, var_i0);
  var_l5 = var_i0;
  var_i0 = 1u;
  var_l6 = var_i0;
  var_i0 = var_l5;
...
u32 w2c__f7(w2c_* instance, u32 var_p0) {
  u32 var_l1 = 0, var_l2 = 0, var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, 
      var_l9 = 0, var_l10 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
...
u32 w2c__f8(w2c_* instance, u32 var_p0, u32 var_p1, u32 var_p2) {
...
u32 w2c__f9(w2c_* instance, u32 var_p0, u32 var_p1) {
  u32 var_l2 = 0, var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, var_l9 = 0, 
      ...
      var_l42 = 0, var_l43 = 0, var_l44 = 0, var_l45 = 0;
  u64 var_l46 = 0, var_l47 = 0, var_l48 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  u64 var_j0, var_j1;
  var_i0 = instance->w2c_g0;
  ...
  var_l5 = var_i0;
  var_i0 = var_l5;
  var_i0 = w2c__f7(instance, var_i0);
  var_l6 = var_i0;
  var_i0 = var_l4;
  var_i1 = var_l6;
  i32_store(&instance->w2c_memory, (u64)(var_i0) + 16, var_i1);
...
u32 w2c__check_pin_0(w2c_* instance, u32 var_p0) {
  u32 var_l1 = 0, var_l2 = 0, var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, 
      var_l9 = 0, var_l10 = 0, var_l11 = 0, var_l12 = 0, var_l13 = 0, var_l14 = 0, var_l15 = 0, var_l16 = 0, 
      var_l17 = 0, var_l18 = 0, var_l19 = 0, var_l20 = 0, var_l21 = 0, var_l22 = 0, var_l23 = 0, var_l24 = 0, 
      var_l25 = 0, var_l26 = 0, var_l27 = 0, var_l28 = 0, var_l29 = 0, var_l30 = 0;
  FUNC_PROLOGUE;
  ...
  var_l11 = var_i0;
  var_i0 = var_l11;
  var_i0 = w2c__f3(instance, var_i0);
  var_i0 = var_l3;
  var_i0 = i32_load(&instance->w2c_memory, (u64)(var_i0) + 24u);
  var_l12 = var_i0;
  var_i0 = var_l12;
  ...
  var_l13 = var_i0;
  var_i0 = var_l13;
  var_i0 = w2c__f5(instance, var_i0);
  var_l14 = var_i0;
  var_i0 = var_l3;
  var_i1 = var_l14;
  i32_store(&instance->w2c_memory, (u64)(var_i0) + 20, var_i1);
  ...
  var_l15 = var_i0;
  var_i0 = var_l15;
  var_i0 = w2c__f6(instance, var_i0);
  var_l16 = var_i0;
  var_i0 = var_l3;
  var_i1 = var_l16;
  i32_store(&instance->w2c_memory, (u64)(var_i0) + 16, var_i1);
  ...
  var_i1 = var_l18;
  var_i2 = var_l19;
  var_i0 = w2c__f8(instance, var_i0, var_i1, var_i2);
  var_l20 = var_i0;
  var_i0 = var_l3;
  var_i1 = var_l20;
  i32_store(&instance->w2c_memory, (u64)(var_i0) + 12, var_i1);
...
void w2c__f18(w2c_* instance, u32 var_p0) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

u32 w2c__f19(w2c_* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = 1024u;
  w2c__f18(instance, var_i0);
  var_i0 = 1028u;
  FUNC_EPILOGUE;
  return var_i0;
}
...
void w2c__0x5F_stdio_exit_0(w2c_* instance) {
  u32 var_l0 = 0;
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = w2c__f19(instance);
  var_i0 = i32_load(&instance->w2c_memory, (u64)(var_i0));
  var_l0 = var_i0;
  var_i0 = !(var_i0);
  if (var_i0) {goto var_B0;}
...
void w2c__f22(w2c_* instance, u32 var_p0) {
  u32 var_l1 = 0, var_l2 = 0;
  FUNC_PROLOGUE;
